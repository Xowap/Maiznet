...
from django.forms import ModelForm, RegexField, ModelChoiceField, CharField, EmailField, ValidationError
...
class UserRegistrationForm(UserCreationForm):
	...
	ticket     = RegexField(max_length = 14, regex = r'^\d{4}-\d{4}-\d{4}$')
